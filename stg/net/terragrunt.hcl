...
inputs = {
  ...
  vpc-cidr-cluster        = "10.1.0.0/16"
  vpc-cidr-assoc          = "100.64.0.0/16"
  subnet-i1               = "100.64.0.0/18"
  subnet-i2               = "100.64.64.0/18"
  subnet-i3               = "100.64.128.0/18"
  subnet-pub1             = "10.1.0.0/21"
  subnet-pub2             = "10.1.8.0/21"
  subnet-pub3             = "10.1.16.0/21"
  subnet-priv1            = "10.1.24.0/21"
  subnet-priv2            = "10.1.32.0/21"
  subnet-priv3            = "10.1.40.0/21"
}
